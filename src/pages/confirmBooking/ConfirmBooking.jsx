      ...
      <table className='w-full text-left text-white border border-white'>
        ...
        <tbody>
          <tr>
            ...
            <td className='p-3 border border-white'>{user.firstName}</td>
          </tr>
          <tr>
            <td className='p-3 border border-white'>Last Name</td>
            <td className='p-3 border border-white'>{user.lastName}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className='p-3 border border-white'>{user.credits}</td>
          </tr>
          <tr>
            <td className='p-3 border border-white'>Login Count</td>
            <td className='p-3 border border-white'>{user.loginCount}</td>
          </tr>
          <tr>
            <td className='p-3 border border-white'>Last Login</td>
            <td className='p-3 border border-white'>{new Date(user.lastLogin).toLocaleString()}</td>
          </tr>
        </tbody>
      </table>
