...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center bg-cover bg-no-repeat bg-center min-h-screen" style={{ backgroundImage: `url(${loginbg})` }}>
        <div className="bg-[#ffffff1a] mx-3 border border-white text-white rounded-lg p-7 max-w-[650px] w-full">
          <div className="">
            ...
            <h2 className="text-[32px] font-semibold capitalize mb-4 Aspekta-650">Ready to use Car Wrap Visualizer</h2>
          ...
          <form onSubmit={handleLogin} className=" space-y-4">
            ...
            <button type="submit" className="w-full cursor-pointer font-[Apercu] mt-6 bg-gradient-to-r from-[#1AE1AB] to-[#712FFF] text-white py-4 rounded-full hover:bg-blue-600">
