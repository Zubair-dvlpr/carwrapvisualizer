...
export default function WorkOrder() {
  ...
  const payload = {
    ...
    ppfCost: Number(formData.ppfCost),
    decalsCost: Number(formData.decalsCost),
    windowTintingCost: Number(formData.windowTintingCost),
    frontPercentage: Number(formData.frontPercentage),
    rearPercentage: Number(formData.rearPercentage),
